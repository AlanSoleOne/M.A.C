...
<head>
    ...
    <link rel="stylesheet" href="css2/estyle.css">
    ...
    <div class="container">
     <form class="form" action="" method="">
        ...
        <label for="nombre" class="form-label" >Direccion</label>
         ...
         <textarea class="form-textarea" id="mensaje" placeholder="Escriba su consulta"></textarea>

            <input class="btn-sublim" type="submit" class="btn-submit" value="Enviar Consulta ">
         </div>
        </div>
     </form>
    </div>
